...
if __name__ == '__main__':
    ...
    ## here are the examples to generate Hamiltonian
    ...
    xxz = XXZ(nqubit, .1, .2, 2.)
    print("\nThe Hamiltonian of xxz model is \n{}".format(xxz.H))

    h2 = Molecular(geometry=[('H', (0., 0., -1.5)), ('Be', (0., 0., 0.)), ('H', (0., 0., 1.5))])
    print(print("\nThe Hamiltonian of H2 molecular is \n{}".format(h2.H)))

    ising = Transverse_fieldIsing(nqubit, .1, 2.)
    s = ising.H
